...
var options = {
  ...
  port: 443,
  path: '/services/T025DU6HX/B0D7C2YT0/t0MHSRjL6aPZ9PgrHySiPp8v',
  method: 'POST'
};

// data-platform-srv-pv https://hooks.slack.com/services/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
// gaurav-test /services/T025DU6HX/B0D7C2YT0/t0MHSRjL6aPZ9PgrHySiPp8v
...
function setMessageInSession(intent, session, callback) {
    ...
    if (messageSlot) {
        ...
        req.write('{"channel": "#gaurav-test", "username": "webhookbot", "text": "[via Alexa]: ' + message + '", "icon_emoji": ":ghost:"}');
        req.end();
    } else {
